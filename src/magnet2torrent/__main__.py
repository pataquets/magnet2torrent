...
def main():
    ...
    #     print("STARTING TO FETCH INFOHASH")
    #     import binascii
    #     info_hash = binascii.unhexlify('319f9be257fbd6f4d4b349bb3b16dfc32f9d3c73')
    #     result = loop.run_until_complete(server.find_peers(info_hash))
    #     print(result)
    #     server.stop()
    #     loop.close()


        # try: # TODO: bucket cleanup / ping? # TODO: stream peers as they're found so we can cancel a search
        #     loop.run_forever()
